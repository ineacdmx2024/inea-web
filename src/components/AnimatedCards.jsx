    ...
    if (Array.isArray(subtitle)) {
      ...
      return (
        <div>
          ...
          >
            <motion.button
              className="mt-4 px-4 py-2 bg-[#611432] text-white rounded-lg mx-auto block hover:bg-[#3a0c1e]"
        ...
        {selectedId && (
          ...
          >
            ...
            >
              ...
              <motion.button
                className="mt-4 px-4 py-2 bg-[#611432] text-white rounded-lg mx-auto block"
