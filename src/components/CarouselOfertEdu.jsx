            ...
            {modalidades.map((noticia, index) => (
              <div key={index} className="px-4">
                <div className="border-0 tablet:border border-slate-300 tablet:shadow-lg rounded-none tablet:rounded-lg h-[400px] letras:h-[420px] p-8 flex flex-col justify-between">
                  ...
                  <Link className="bg-[#611232] text-white text-xs letras:text-[13.5px] py-2 px-4 rounded-full hover:bg-[#FFFFFF] hover:text-black  hover:ring-[#611232] hover:ring-4 mx-auto block font-light" href={`/oferta-educativa${noticia.url}`}>
                    Ir al sitio
                  </Link>
                </div>
              </div>
