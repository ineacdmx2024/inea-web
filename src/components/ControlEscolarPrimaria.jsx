  ...
  return (
    <div>
      ...
      <div
        ...
        className="p-4 mb-4 mt-2 border border-[#A57F2C] rounded-lg bg-yellow-50 dark:bg-gray-800 text-[#333334] dark:text-yellow-300 dark:border-yellow-800"
        role="alert"
      >
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-row items-start gap-[10px]">
            ...
            <a
              ...
              className="text-[#333334] hover:text-[#A27D36] hover:underline cursor-pointer"
            >
