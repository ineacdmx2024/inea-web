...
function SeccionLigasInte() {
  ...
  useEffect(() => {
    const fetchFijos = async () => {
      //const res = await fetch("https://inea-web-backend-production.up.railway.app/api/i-enlaces?filters[Fijo][$eq]=true&populate=*")
      const res = await fetch("https://inea-web-backend-production.up.railway.app/api/i-enlaces?filters[Fijo][$eq]=true&populate=*")
    ...
    const fetchEnlaces = async () => {
      //const res = await fetch("https://inea-web-backend-production.up.railway.app/api/i-enlaces?filters[Fijo][$eq]=false&populate=*")
      const res = await fetch("https://inea-web-backend-production.up.railway.app/api/i-enlaces?filters[Fijo][$eq]=false&populate=*")
      const data = await res.json()
    ...
    <>
      ...
      <div className="p-2 pt-0">
        ...
        <div className="carrusel desktop-carousel">
          <Slider
            {...settings}
            className="bg-white border tablet:border-0 border-slate-300 tablet:shadow-none rounded-lg tablet:rounded-none mx-auto !z-5 w-full max-w-[300px] letras:max-w-[360px] ofertaEdu:max-w-[400px] tablet:max-w-[1150px] mt-12 px-4 tablet:px-0 "
          >
