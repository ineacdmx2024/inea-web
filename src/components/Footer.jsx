...
const Footer = () => {
  ...
  return (
    ...
    <footer className=" bg-[#13322B] h-auto">
      <div className="p-8 mx-auto max-w-screen-xl sm:p-6" id='content'>
        <div className="md:flex" id='Content'>
          <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com" className="flex items-center">
              <img src="/LogoEducacion.svg" className="mr-3 h-12" alt="Logo Educacion" />
            </a>
            <br />
            <a href="/" className="flex items-center">
              <img src="/LogoINEACDMX_withe.svg" className="mr-3 h-[70px]" alt="Logo INEA" />
            </a>
          </div>
