...
const Navbar = () => {
  ...
  return (
    ...
    <div ref={navRef} className="navBar w-screen max-w-full">
      <div className="bg-[#611232] w-full">
        ...
        <div
          className={`absolute left-0 mt-0.5 ${isClickOE ? "block" : "hidden"} bg-gray-100 text-black rounded shadow-lg transition-opacity duration-300 ease-in-out delay-200 z-50`}
          >
          <Link
  ...
  {/* Trámites */}
        <div className="group relative">
          ...
          <div
            className={`absolute left-0 mt-0.5 ${isClickS ? "block" : "hidden"} bg-gray-100 text-black rounded shadow-lg transition-opacity duration-300 ease-in-out delay-200 z-50`}
            >
            <Link
        ...
        >
          Ubicación
              ...
              <div className="group relative">
                ...
                <div
                  className={`absolute left-0 mt-0.5 ${isClickCE ? "block" : "hidden"} bg-gray-100 text-black rounded shadow-lg transition-opacity duration-300 ease-in-out delay-200 z-50`}
                >
                  <Link
                    onClick={closeAllMenus}
              ...
              <div className="group relative">
                ...
                <div
                  className={`absolute left-0 mt-0.5 ${isClickI ? "block" : "hidden"} bg-gray-100 text-black rounded shadow-lg transition-opacity duration-300 ease-in-out delay-200 z-50`}
                >
                  <Link
                    onClick={closeAllMenus}
