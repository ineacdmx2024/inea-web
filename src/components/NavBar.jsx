...
//         <nav className="bg-[#3a0c1e]  py-3.5">
//           <div className="flex items-center justify-between py-[0.06rem] px-4 h-[37px] w-full pl-[10px] md:ml-[1rem] md:px-0">
//             <div className="overflow-hidden flex items-center  justify-between w-screen pl-0 pr-0 md:pl-4 md:mx-auto md:max-w-[1200px]" id="Minf">
//               <div></div>
//               <div className="bg-black p-1.5 mx-auto flex items-end space-x-10">
//                 <div className="hidden md:block">
//                   <div className="flex items-end space-x-5">
//                     <Link
//                       href="/"
