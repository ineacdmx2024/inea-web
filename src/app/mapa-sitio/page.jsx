            ...
            <PagSec Enlaces={enlacesL} Titulo="Mapa del sitio">
                <div className="space-y-6 text-[#333334] text-base sm:text-[18px]">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li><Link href="/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                            Inicio</Link></li>
                        <li><Link href="https://www.gob.mx/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li><Link href="/oferta-educativa/que-modalidad-elijo" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer
                            hover:underline">¿Qué modalidad elijo?</Link></li>
                        <li><Link href="/oferta-educativa/presencial" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer
                            hover:underline">Presencial</Link></li>
                        <li><Link href="/oferta-educativa/enlinea" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">En línea (AprendeINEA)</Link></li>
                        <li><Link href="/oferta-educativa/examen-unico" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Exámen único</Link></li>
                        <li><Link href="/oferta-educativa/examen-diagnostico" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li><Link href="/servicios/servedu" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Servicios educativos</Link></li>
                        <li><Link href="https://certificacion.inea.gob.mx/DescCertificado.aspx" 
                            className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                            Descarga tu certificado</Link></li>
                        <li><Link href="/servicios/solicitud-duplicados" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Solicitud duplicados</Link></li>
                        <li><Link href="https://www.gob.mx/curp/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Consulta tu CURP</Link></li>
                        <li><Link href="/servicios/constancia-comipems" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Solicita constancia COMIPEMS</Link></li>
                        <li><Link href="/servicios/reposicion-certificados" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Reposición de certificados SEP</Link></li>
                        <li><Link href="/servicios/descargar-modulos" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                            Descarga material de estudio</Link></li>
                        <li><Link href="/servicios/revalidacion-extranjeros" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Revalidación a extranjeros</Link></li>
                        <li><Link href="/servicios/te-contactamos" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li><Link href="/materiales" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li><Link href="/ubicacion" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li><Link href="http://www.inea.gob.mx/servicios_en_linea/Consulta_avance_academico.html" 
                            className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">Consulta tu avance académico</Link></li>
                        <li><Link href="http://siga.inea.gob.mx:8080/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">SIGA PEC</Link></li>
                        <li><Link href="http://siga.inea.gob.mx/figuras/Account/Login?ReturnUrl=%2Ffiguras%2F" 
                            className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">SIGA FIGURAS</Link></li>
                        <li><Link href="http://sael.inea.gob.mx/Login.aspx?ReturnUrl=/&AspxAutoDetectCookieSupport=1" 
                            className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">SAEL</Link></li>
                        <li><Link href="/planeacion" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                ...
                {/* Sección: INTRANET */}
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li><Link href="http://cdmx.inea.gob.mx/CATN2/login.asp" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer
                            hover:underline">Mesa de servicios</Link></li>
                        <li><Link href="http://cdmx.inea.gob.mx/gestion/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer
                            hover:underline">Sistema de gestión</Link></li>
                        <li><Link href="http://cdmx.inea.gob.mx/oficios/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Sistema de oficios</Link></li>
                        <li><Link href="http://cdmx.inea.gob.mx/SIMA/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                        ...
                        <li><Link href="http://sibiplac.inea.gob.mx/Sibiplac/Login.aspx?ReturnUrl=%2fSibiplac%2fReportes.aspx" 
                            className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">SIBIPLAC</Link></li>
                        <li><Link href="http://plazas.conevyt.org.mx:8080/plazas/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">SINAPLAC</Link></li>
                        <li><Link href="http://cdmx.inea.gob.mx/comipems/login.asp" className="text-[#700425] hover:text-[#3a0c1e] cursor.pointer 
                        ...
                        <li><Link href="http://df.sasa.inea.gob.mx/INEAGUI/guiLogin.aspx?ReturnUrl=%2fINEAGUI%2fdefault.aspx" 
                            className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">SASA</Link></li>
                        <li><Link href="http://satic.inea.gob.mx/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                            SATIC</Link></li>
                        <li><Link href="https://login.microsoftonline.com/login.srf?wa=wsignin1.0&rpsnv=4&ct=1420848406&rver=6.4.6456.0&wp=MCMBI&wreply=
                            ...
                            className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">Correo Institucional</Link></li>
                        <li><Link href="/INTRANET/inicio-sesion" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                    ...
                    <div>
                        ...
                        <ul className="list-disc list-inside space-y-1">
                            <li><Link href="/servicio-social" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li><Link href="https://historico.datos.gob.mx/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                        ...
                        <li><Link href="/glosario" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
                            Glosario</Link></li>
                        <li><Link href="https://www.gob.mx/inea/" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer 
                            hover:underline">Página oficial INEA Nacional</Link></li>
                        <li><Link href="https://www.gob.mx" className="text-[#700425] hover:text-[#3a0c1e] cursor-pointer hover:underline">
