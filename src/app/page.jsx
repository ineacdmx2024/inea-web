...
const patria = localFont({
  src: "../public/fonts/Patria-Regular.woff2",
  variable: "--font-patria",
});

function Page() {
  return (
    <main className={`mx-auto ${notoSans.variable} ${patria.variable} font-sans text-[#333334] bg-white pt-[150px] pb-[100px] w-full overflow-x-hidden`}>
      <div>
        {/* <img
     ...
     {/* Sección de presentación de INEA CDMX */}
      <div className="mx-auto my-16 w-11/12 medida3:w-4/5 arrow:w-[750px] tablet:w-[1142px] text-center">
        <h1 className="text-[33px] font-patria text-[#333334]">
     ...
     {/* Sección del blog con CarouselBlog */}
      <div className="mx-auto my-20 w-11/12 medida3:w-4/5 arrow:w-[750px] tablet:w-[1142px]">
        <h1 className="text-2xl font-patria text-[#333334] mb-2 letras:text-3xl">
          Blog
        </h1>
      ...
      <div className="mx-auto w-11/12 medida3:w-4/5 arrow:w-[750px] tablet:w-[1170px] mt-[97px] mb-2">
        <div className="mb-6">
          <h1 className="text-2xl font-patria text-[#333334] letras:text-3xl">
            Ubicación
          </h1>
