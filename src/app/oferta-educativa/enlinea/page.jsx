...
const linea = {
  ...
  paragraphs: [
    ...
    "Una vez registrado, cada estudiante tiene la libertad de estudiar a su ritmo a través de su teléfono o computadora, sin restricciones de tiempo para completar los módulos. Sin embargo, se espera que mantengan una participación activa en la plataforma. El nivel Primaria comprende de cinco módulos, mientras Secundaria consta de nueve módulos.",
