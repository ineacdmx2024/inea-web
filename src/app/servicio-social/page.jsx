      ...
      <PagSec Enlaces={enlacesL} Titulo="Realiza tu servicio social en el INEA Ciudad de México">
        ...
        >
          ...
          <p><Link href="/ubicacion" 
            ...
            className="text-[#333334] cursor-pointer transition-colors duration-200 ease-in-out no-underline hover:underline hover:text-[#3a0c1e]"
            >
          ...
          <div className="flex items-start gap-4">
            <div className="flex items-center justify-center w-[64px] h-[64px] bg-[#611432] rounded-lg">
