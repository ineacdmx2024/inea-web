                  ...
                  <button
                    className={`${
                      ...
                      opcionSeleccionada === key
                        ...
                        : "text-[#333334] border border-gray-200 rounded-t-lg hover:text-[#611432] hover:font-bold hover:bg-slate-50"
                    }`}
          ...
          <div className="pt-[25px] text-lg mt-[20px] ">
            ...
            <ul className="list-disc ml-[25px]">
              <li className="mb-5 break-words">
                ...
                <a
                  // className="a-sep"
                  className="text-[#611432] cursor-pointer hover:text-[#3a0c1e] hover:underline"
            ...
            <div className="flex flex-wrap mb-0 mt-0 gap-y-1 gap-x-2">
              {[
                ...
                <button
                  key={id}
                  type="button"
                  className="text-[#611432] rounded-lg hover:text-white border border-[#611432] hover:bg-[#611432] focus:ring-4 focus:outline-none focus:ring-[#3a0c1e] focus:bg-[#611432] focus:text-white font-medium px-5 py-2 text-center me-1 mb-0 mt-0 text-lg flex items-center justify-center gap-2"
                  onClick={() => {
