        ...
        <div className="pt-4 leading-7 justify-start text-[#333334] text-[18px] ">
          ...
          >
            ...
            <div className="pt-3 pb-3">
              <button
                className="m-auto letras:ml-auto bg-[#611432] text-white py-3 px-3 hover:bg-white hover:text-[#611432] rounded-full border-2 border-[#611432] block w-full justify-center"
                type="submit"
                value="Enviar"
              >
                Enviar información
